...
Sms::Smsbao.configure do |c|
  c.username = smsbao_config[:username]
  c.password  = smsbao_config[:password]
end

Sms::Nexmo.configure do |c|
  c.username = nexmo_config[:username]
  c.password  = nexmo_config[:password]
end
